...
public class RegistrationVO {
	...
	public String toString() {
		return "RegistrationVO [CUSTOMER_ID=" + CUSTOMER_ID
				+ ", ACCOUNT_NUMBER=" + ACCOUNT_NUMBER + ", NAME=" + NAME
				+ ", USERNAME=" + USERNAME + ", PASSWORD=" + PASSWORD
				+ ", GUARDIAN_TYPE=" + GUARDIAN_TYPE + ", GUARDIAN_NAME="
				+ GUARDIAN_NAME + ", ADDRESS=" + ADDRESS + ", CITIZENSHIP="
				+ CITIZENSHIP + ", COUNTRY=" + COUNTRY + ", STATE=" + STATE
				+ ", EMAIL=" + EMAIL + ", GENDER=" + GENDER
				+ ", MARITAL_STATUS=" + MARITAL_STATUS + ", CONTACT_NUMBER="
				+ CONTACT_NUMBER + ", DOB=" + DOB + ", REG_DATE=" + REG_DATE
				+ ", ACTIVATION_DATE=" + ACTIVATION_DATE + ", ACC_TYPE="
				+ ACC_TYPE + ", BRANCH_NAME=" + BRANCH_NAME
				...
				+ ", REF_ACC_NO=" + REF_ACC_NO + ", REF_ADDRESS=" + REF_ADDRESS
				+ "]";
	}
	...
	public void setCONTACT_NUMBER(long string) {
	...
	public long getINITIAL_DEPOSIT_AMOUNT() {
		return INITIAL_DEPOSIT_AMOUNT;
	}
	public void setINITIAL_DEPOSIT_AMOUNT(long iNITIAL_DEPOSIT_AMOUNT) {
		INITIAL_DEPOSIT_AMOUNT = iNITIAL_DEPOSIT_AMOUNT;
	}
	...
	private long INITIAL_DEPOSIT_AMOUNT ;                 
